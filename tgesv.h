...
namespace tpp
{
	...
	struct gesv_matrix<T, STM, STV, SI,
		type_pack<valence_info<M_V_TYPE, 1, M_C_MASK, 1, false, M_JOIN_WITH, M_ORDER> >,
		type_pack<valence_info<C_V_TYPE, 3, C_C_MASK, 3, false, C_JOIN_WITH, C_ORDER> >,
		type_pack<valence_info<V_V_TYPE, 2, V_C_MASK, 2, false, V_JOIN_WITH, V_ORDER> >, R_CONT>
	{
	...
	type_pack<valence_info<M_V_TYPE, 1, M_C_MASK, 1, false, M_JOIN_WITH, M_ORDER> >,
	type_pack<valence_info<C_V_TYPE, 3, C_C_MASK, 3, false, C_JOIN_WITH, C_ORDER> >,
	type_pack<valence_info<V_V_TYPE, 2, V_C_MASK, 2, false, V_JOIN_WITH, V_ORDER> >, 0>
	{
		static_assert(C_C_MASK & 2,"gesv: Linked dimension of arguments should be continuous");
		static BLAS_INTEGER run_gesv(const STM& stm, const STV& stv, T *M, T *V, BLAS_INTEGER *IPIV)
		{
	...
	type_pack<valence_info<M_V_TYPE, 1, M_C_MASK, 1, false, M_JOIN_WITH, M_ORDER> >,
	type_pack<valence_info<C_V_TYPE, 3, C_C_MASK, 3, false, C_JOIN_WITH, C_ORDER> >, R_CONT>
	{
		static_assert(C_C_MASK & 2,"gesv: Linked dimension of arguments should be continuous");
		static BLAS_INTEGER run_gesv(const STM& stm, const STV& stv, T *M, T *V, BLAS_INTEGER *IPIV)
		{
	...
	struct gesv_vector<T, STM, STV, SI,
		type_pack<valence_info<M_V_TYPE, 1, M_C_MASK, 1, false, M_JOIN_WITH, M_ORDER> >,
		type_pack<valence_info<C_V_TYPE, 3, C_C_MASK, 3, false, C_JOIN_WITH, C_ORDER> >, 0>
	{
		static_assert(C_C_MASK & 2,"gesv: Linked dimension of arguments should be continuous");
		static BLAS_INTEGER run_gesv(const STM& stm, const STV& stv, T *M, T *V, BLAS_INTEGER *IPIV)
		{
	...
	struct gesv_insert_mask<valence_info<V_TYPE, MASK, C_MASK, V_MASK, IS_JOINABLE, JOIN_WITH, ORDER>, type_pack<valence_info<H_V_TYPE, H_MASK, H_C_MASK, H_V_MASK, H_IS_JOINABLE, H_JOIN_WITH, H_ORDER>, VI...>, type_pack<RES...> >:
		public std::conditional<
			...
			gesv_insert_mask<valence_info<V_TYPE, MASK, C_MASK, V_MASK, IS_JOINABLE, JOIN_WITH, ORDER>, type_pack<VI...>, type_pack<RES..., valence_info<H_V_TYPE, H_MASK, H_C_MASK, H_V_MASK, H_IS_JOINABLE, H_JOIN_WITH, H_ORDER> > >
		>::type
	{
	};

	template <int V_TYPE, int MASK, int C_MASK, int V_MASK, bool IS_JOINABLE, int JOIN_WITH, size_t ORDER, typename ... RES>
	struct gesv_insert_mask<valence_info<V_TYPE, MASK, C_MASK, V_MASK, IS_JOINABLE, JOIN_WITH, ORDER>, type_pack<>, type_pack<RES...> >:
...
//  M_FREE
	...
	struct gesv_by_mask<T, STM, STV, type_pack<type_pack<valence_info<V_TYPE, 1, C_MASK, V_MASK, IS_JOINABLE, JOIN_WITH, ORDER>, VI...>, SI>, type_pack<M_FREE...>, type_pack<COMMON...>, type_pack<V_FREE...>, R_CONT, M_CONT, V_CONT>:
		public gesv_by_mask<T, STM, STV, type_pack<type_pack<VI...>, SI>, typename gesv_insert_mask<valence_info<V_TYPE, 1, C_MASK, V_MASK, IS_JOINABLE, JOIN_WITH, ORDER>, type_pack<M_FREE...>, type_pack<> >::type, type_pack<COMMON...>, type_pack<V_FREE...>, R_CONT, M_CONT || (C_MASK & 1), V_CONT>
	{
		static_assert(V_MASK==1,"gesv: Free matrix dimension cannot be optimized. Use defaultIndex or segmentIndex only");
	};
//  COMMON
	template <typename T, typename STM, typename STV, int V_TYPE, int C_MASK, int V_MASK, bool IS_JOINABLE, int JOIN_WITH, size_t ORDER, typename ... VI, typename SI, typename ... M_FREE, typename ... COMMON, typename ... V_FREE, bool R_CONT, bool M_CONT, bool V_CONT>
	struct gesv_by_mask<T, STM, STV, type_pack<type_pack<valence_info<V_TYPE, 3, C_MASK, V_MASK, IS_JOINABLE, JOIN_WITH, ORDER>, VI...>, SI>, type_pack<M_FREE...>, type_pack<COMMON...>, type_pack<V_FREE...>, R_CONT, M_CONT, V_CONT>:
		public gesv_by_mask<T, STM, STV, type_pack<type_pack<VI...>, SI>, type_pack<M_FREE...>, typename gesv_insert_mask<valence_info<V_TYPE, 3, C_MASK, V_MASK, IS_JOINABLE, JOIN_WITH, ORDER>, type_pack<COMMON...>, type_pack<> >::type, type_pack<V_FREE...>, R_CONT || ((V_MASK==3 && (C_MASK & 1))), M_CONT || (C_MASK & 1), V_CONT || (C_MASK & 2)>
	{
...
//	V_FREE
	template <typename T, typename STM, typename STV, int V_TYPE, int C_MASK, int V_MASK, bool IS_JOINABLE, int JOIN_WITH, size_t ORDER, typename ... VI, typename SI, typename ... M_FREE, typename ... COMMON, typename ... V_FREE, bool R_CONT, bool M_CONT, bool V_CONT>
	struct gesv_by_mask<T, STM, STV, type_pack<type_pack<valence_info<V_TYPE, 2, C_MASK, V_MASK, IS_JOINABLE, JOIN_WITH, ORDER>, VI...>, SI>, type_pack<M_FREE...>, type_pack<COMMON...>, type_pack<V_FREE...>, R_CONT, M_CONT, V_CONT>:
		public gesv_by_mask<T, STM, STV, type_pack<type_pack<VI...>, SI>, type_pack<M_FREE...>, type_pack<COMMON...>, typename gesv_insert_mask<valence_info<V_TYPE, 2, C_MASK, V_MASK, IS_JOINABLE, JOIN_WITH, ORDER>, type_pack<V_FREE...>, type_pack<> >::type, R_CONT, M_CONT, V_CONT || (C_MASK & 2)>
	{
...
//  DONE MATRIX
	...
	struct gesv_by_mask<T, STM, STV, type_pack<type_pack<>, SI>, type_pack<M_FREE...>, type_pack<COMMON...>, type_pack<V_FREE...>, R_CONT, M_CONT, V_CONT>:
		public gesv_matrix<T, STM, STV, SI, type_pack<M_FREE...>, type_pack<COMMON...>, type_pack<V_FREE...>, R_CONT>
	{
...
//  DONE VECTOR
	...
	struct gesv_by_mask<T, STM, STV, type_pack<type_pack<>, SI>, type_pack<M_FREE...>, type_pack<COMMON...>, type_pack<>, R_CONT, M_CONT, V_CONT>:
		public gesv_vector<T, STM, STV, SI, type_pack<M_FREE...>, type_pack<COMMON...>, R_CONT>
	{
		static_assert(M_CONT,"gesv: One of dimensions of Matrix of coefficients should be continuous");
	...
	struct gesv_runner<T, stuple<M_SNUM, M_CONT, M_IS_INDEXED, M_OST, M_SHAPES...>, stuple<V_SNUM, V_CONT, V_IS_INDEXED, V_OST, V_SHAPES...> >:
		public gesv_by_mask<T, stuple<M_SNUM, M_CONT, M_IS_INDEXED, M_OST, M_SHAPES...>, stuple<V_SNUM, V_CONT, V_IS_INDEXED, V_OST, V_SHAPES...>,
			...
			type_pack<>, type_pack<>, type_pack<>, false, false, false>
	{
