...
// NOT LAST; FIRST
	...
	struct div_create_general_loop<T, STR, STA, SI, SPREAD, RA, type_sequence<HEAD, SUMA...>, BASE_LOOP>:
		public div_create_general_loop<T, STR, STA, SI, SPREAD, RA, type_sequence<SUMA...>, div_suma_loop<T, STR, STA, SI, HEAD, BASE_LOOP> >
	{
	};

	template <typename T, typename STR, typename STA, typename SI, typename SPREAD, typename HEAD, typename ... RA, typename BASE_LOOP>
	struct div_create_general_loop<T, STR, STA, SI, SPREAD, type_sequence<HEAD, RA...>, type_sequence<>, BASE_LOOP>:
		public div_create_general_loop<T, STR, STA, SI, SPREAD, type_sequence<RA...>, type_sequence<>, div_ra_loop<T, STR, STA, SI, HEAD, BASE_LOOP> >
	{
	};

	template <typename T, typename STR, typename STA, typename SI, typename HEAD, typename ... SPREAD, typename BASE_LOOP>
	struct div_create_general_loop<T, STR, STA, SI, type_sequence<HEAD, SPREAD...>, type_sequence<>, type_sequence<>, BASE_LOOP>:
		public div_create_general_loop<T, STR, STA, SI, type_sequence<SPREAD...>, type_sequence<>, type_sequence<>, div_spread_loop<T, STR, STA, SI, typename iterator_getter_by_src_v_type<STR, SI, 0, HEAD::v_type>::template iterator_type<T>, false, BASE_LOOP> >
	{
	};

	template <typename T, typename STR, typename STA, typename SI, typename HEAD, typename BASE_LOOP>
	struct div_create_general_loop<T, STR, STA, SI, type_sequence<HEAD>, type_sequence<>, type_sequence<>, BASE_LOOP>:
		public div_create_general_loop<T, STR, STA, SI, type_sequence<>, type_sequence<>, type_sequence<>, div_spread_loop<T, STR, STA, SI, typename iterator_getter_by_src_v_type<STR, SI, 0, HEAD::v_type>::template iterator_type<T>, true, BASE_LOOP> >
	{
	};
	...
	struct div_insert_mask<valence_info<V_TYPE, MASK, C_MASK, V_MASK, IS_JOINABLE, JOIN_WITH, ORDER>, type_sequence<valence_info<H_V_TYPE, H_MASK, H_C_MASK, H_V_MASK, H_IS_JOINABLE, H_JOIN_WITH, H_ORDER>, VI...>, type_sequence<RES...> >:
		public std::conditional<
			...
			div_insert_mask<valence_info<V_TYPE, MASK, C_MASK, V_MASK, IS_JOINABLE, JOIN_WITH, ORDER>, type_sequence<VI...>, type_sequence<RES..., valence_info<H_V_TYPE, H_MASK, H_C_MASK, H_V_MASK, H_IS_JOINABLE, H_JOIN_WITH, H_ORDER> > >
		>::type
	{
	};

	template <int V_TYPE, int MASK, int C_MASK, int V_MASK, bool IS_JOINABLE, int JOIN_WITH, size_t ORDER, typename ... RES>
	struct div_insert_mask<valence_info<V_TYPE, MASK, C_MASK, V_MASK, IS_JOINABLE, JOIN_WITH, ORDER>, type_sequence<>, type_sequence<RES...> >:
...
//  SPREAD
	...
	struct div_by_mask<T, STR, STA, type_sequence<type_sequence<valence_info<V_TYPE, 1, C_MASK, V_MASK, IS_JOINABLE, JOIN_WITH, ORDER>, VI...>, SI>, type_sequence<SPREAD...>, type_sequence<RA...>, type_sequence<SUMA...>, R_CONT, A_CONT>:
		public div_by_mask<T, STR, STA, type_sequence<type_sequence<VI...>, SI>, typename div_insert_mask<valence_info<V_TYPE, 1, C_MASK, V_MASK, IS_JOINABLE, JOIN_WITH, ORDER>, type_sequence<SPREAD...>, type_sequence<> >::type, type_sequence<RA...>, type_sequence<SUMA...>, R_CONT, A_CONT>
	{
	};
//  RA
	template <typename T, typename STR, typename STA, int V_TYPE, int C_MASK, int V_MASK, bool IS_JOINABLE, int JOIN_WITH, size_t ORDER, typename ... VI, typename SI, typename ... SPREAD, typename ... RA, typename ... SUMA, bool R_CONT, bool A_CONT>
	struct div_by_mask<T, STR, STA, type_sequence<type_sequence<valence_info<V_TYPE, 3, C_MASK, V_MASK, IS_JOINABLE, JOIN_WITH, ORDER>, VI...>, SI>, type_sequence<SPREAD...>, type_sequence<RA...>, type_sequence<SUMA...>, R_CONT, A_CONT>:
		public div_by_mask<T, STR, STA, type_sequence<type_sequence<VI...>, SI>, type_sequence<SPREAD...>, typename div_insert_mask<valence_info<V_TYPE, 3, C_MASK, V_MASK, IS_JOINABLE, JOIN_WITH, ORDER>, type_sequence<RA...>, type_sequence<> >::type, type_sequence<SUMA...>, R_CONT || ((V_MASK==3 && (C_MASK & 1))), A_CONT || ((V_MASK==3 && (C_MASK & 2)))>
	{
	};
//	SUMA
	template <typename T, typename STR, typename STA, int V_TYPE, int C_MASK, int V_MASK, bool IS_JOINABLE, int JOIN_WITH, size_t ORDER, typename ... VI, typename SI, typename ... SPREAD, typename ... RA, typename ... SUMA, bool R_CONT, bool A_CONT>
	struct div_by_mask<T, STR, STA, type_sequence<type_sequence<valence_info<V_TYPE, 2, C_MASK, V_MASK, IS_JOINABLE, JOIN_WITH, ORDER>, VI...>, SI>, type_sequence<SPREAD...>, type_sequence<RA...>, type_sequence<SUMA...>, R_CONT, A_CONT>:
		public div_by_mask<T, STR, STA, type_sequence<type_sequence<VI...>, SI>, type_sequence<SPREAD...>, type_sequence<RA...>, typename div_insert_mask<valence_info<V_TYPE, 2, C_MASK, V_MASK, IS_JOINABLE, JOIN_WITH, ORDER>, type_sequence<SUMA...>, type_sequence<> >::type, R_CONT, A_CONT>
	{
	};
...
//	DONE just spread
	...
	struct div_by_mask<T, STR, STA, type_sequence<type_sequence<>, SI>, type_sequence<valence_info<S_V_TYPE, 1, S_C_MASK, 1, S_IS_JOINABLE, S_JOIN_WITH, S_ORDER>, SPREAD...>, type_sequence<>, type_sequence<>, R_CONT, A_CONT>:
		public div_create_general_loop<T, STR, STA, SI, type_sequence<SPREAD...>, type_sequence<>, type_sequence<>, div_just_spread_loop<T, STR, STA, SI, valence_info<S_V_TYPE, 1, S_C_MASK, 1, S_IS_JOINABLE, S_JOIN_WITH, S_ORDER> > >
	{
...
//	DONE COMMON
	...
	struct div_by_mask<T, STR, STA, type_sequence<type_sequence<>, SI>, type_sequence<SPREAD...>, type_sequence<RA...>, type_sequence<SUMA...>, R_CONT, A_CONT>:
		public div_create_general_loop<T, STR, STA, SI, type_sequence<SPREAD...>, type_sequence<RA...>, type_sequence<SUMA...>, div_common_loop<T, STR, STA, SI> >
	{
		using vi_by_mask=type_sequence<
				type_sequence<>,
	...
	struct div_runner: public div_by_mask<T, STR, STA, typename make_valence_info_and_join<STR, STA>::type, type_sequence<>, type_sequence<>, type_sequence<>, false, false>
	{
	};
